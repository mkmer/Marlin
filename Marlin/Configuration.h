...
#define USE_ZMIN_PLUG // Kasper - no z homing
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 4535.44, 200 } // (2267.72 Kasper - MPC w/threaded rod @1/16 steps
/** Moved to 32step stepper^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 400, 400, 35, 2000 }
