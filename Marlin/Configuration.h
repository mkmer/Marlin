...
#define STRING_CONFIG_H_AUTHOR "(Michael Kasper, flsun Kossel Mini)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 208.2        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 267.1             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -1.05, -.81, 0.0 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 96.5 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define INVERT_E0_DIR true // MJK new extruder
