...
#define X_DUAL_STEPPER_DRIVERS // Kasper X-Dual Steppers
...
#define Y_DUAL_STEPPER_DRIVERS // Kasper Y-Dual steppers
#if ENABLED(Y_DUAL_STEPPER_DRIVERS)
  #define INVERT_Y2_VS_Y_DIR true   // Kasper - inverted on cable Set 'true' if Y motors should rotate in opposite directions
